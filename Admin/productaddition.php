...
$sql1="INSERT INTO tbl_product(product_name,product_description,product_image,unit_price,available_quantity,subcategory_name,category_name,product_keywords)
VALUES('$p_name','$p_des','$p_image','$p_price','$p_quan','$sub_n', '$cat_n', '$key')";
