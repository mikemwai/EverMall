...
<!--/Top Navbar/-->
    ...
    <div>
		<button type="button" onclick="window.location.href='admin_page(Categories).php';">Add New</button>
	</div>
    ...
    <thead>
         ...
         <tr>
            ...
            <td>
               <a href="admin_update(Categories).php?edit=<?php echo $row["category_id"];?>" class="btn"> edit </a>
               <a href="admin(Categories).php?delete=<?php echo $row["category_id"];?>" class="btn"> delete </a>
            </td>
         </tr>
         <?php 
            }
