...
if (!$conn) {
  ...
  $sql = "SELECT id, code, vendor_id, total_amount,status, date_created FROM order_list WHERE status=5";
...
<body>
    <section id="sidebar">
        ...
        <ul class="side-menu top">
            ...
            <li>
            <a href="https://localhost/E-buy/productpage.php">
            <i class="fa fa-tag"></i>
      ...
      <a href="#">Logout</a>
        ...
        <table class="table" style= "width: 100%">
            <thead>
                ...
                <tbody>
                    <?php
                require_once("cancelledorders.php");
