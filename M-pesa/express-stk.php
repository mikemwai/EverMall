...
$config = array(
    ...
    "key"              => "dYeggGYpUrA1pihFIM0z111c5BJdyp2p", //Enter your consumer key here
    "secret"           => "nJgsUju7NRGIhzjb", //Enter your consumer secret here
    "username"         => "apitest",
...
if (isset($_POST['phone_number'])) {
    ...
    if($result['ResponseCode'] === "0"){         //STK Push request successful
        ...
        $sql = "INSERT INTO `stkpush`(`ID`, `OrderNo`, `Amount`, `Phone`, `CheckoutRequestID`, `MerchantRequestID`) VALUES ('','".$orderNo."','".$amount."','".$phone."','".$CheckoutRequestID."','".$MerchantRequestID."');";
